...
class DeskPlant extends StatefulWidget {
  ...
  @override
  _DeskPlantState createState() => _DeskPlantState();
}

class _DeskPlantState extends State<DeskPlant> {
  //CRUD
  ...
  Future<void> update() async {
    ...
    CollectionReference tanaman = firestore.collection("tanaman");

    await tanaman.doc(widget.id).update({
      "nama": Nama.text,
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          ...
          content: Text("Tanaman Selesai di Edit")));
          Navigator.push(
          context, MaterialPageRoute(builder: (_) => ReadPlant()));
    });
  }
  //END CRUD
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Admin : Deskripsi Tanaman"),
