...
class _DeskPenyakitState extends State<DeskPenyakit> {
  ...
  Future<void> update() async {
    ...
    CollectionReference penyakit = firestore.collection("penyakit");

    await penyakit.doc(widget.id).update({
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          ...
          content: Text("Penyakit Selesai di Edit")));
          Navigator.push(
          context, MaterialPageRoute(builder: (_) => readPenyakit()));
    });
  }
  //END CRUD
